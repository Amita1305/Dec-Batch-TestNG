...
public class DataDriveExcel {
	...
	public void f() throws Exception {
		...
		float MaturityValueFloat=Float.parseFloat(maturityValue);
		int MaturityValueInt=(int)MaturityValueFloat;
		System.out.println(MaturityValueInt);
		
        System.out.println("Maturity Value for : "+df.formatCellValue(principleCell).toString()+ " is " + MaturityValueInt +" | Maturity Value from excel : "+df.formatCellValue(matValue));
		
	    Assert.assertEquals(MaturityValueInt,df.formatCellValue(matValue).toString());
